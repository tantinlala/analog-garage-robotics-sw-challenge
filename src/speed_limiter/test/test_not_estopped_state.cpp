...
TEST_F(NotEstoppedTest, When_BoundariesOutOfOrder_ExpectThrow)
{
    static const NotEstoppedState::Params kBadParams{ 
        { { StateId::STOP, 800.0}, {StateId::SLOW, 400.0}, {StateId::FULL_SPEED, std::numeric_limits<float>::infinity()} },
        50.0,
    };
...
{
    static const NotEstoppedState::Params kBadParams = { 
        { {StateId::STOP, 400.0}, {StateId::STOP, 800.0}, {StateId::FULL_SPEED, std::numeric_limits<float>::infinity()} },
        50.0,
    };
...
{
    static const NotEstoppedState::Params kBadParams = { 
        { {StateId::STOP, 400.0}, {StateId::SLOW, 800.0}, {StateId::ESTOPPED, std::numeric_limits<float>::infinity()} },
        50.0,
    };
...
{
    static const NotEstoppedState::Params kBadParams = { 
        { {StateId::STOP, 400.0}, {StateId::SLOW, 800.0}, {StateId::num_state_ids, std::numeric_limits<float>::infinity()} },
        50.0,
    };
...
INSTANTIATE_TEST_SUITE_P(Transition, NotEstoppedTest, 
    Values(
        // STOP State
